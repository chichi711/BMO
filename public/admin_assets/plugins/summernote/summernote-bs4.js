  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        var src = '//www.youtube.com/embed/' + youtubeId ;
        $video = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" frameborder="0" src="'+src+'">').attr('frameborder', 0);
      ...
      // $video = '<div class="embed-responsive embed-responsive-16by9">'+$video+'</div>';
      return $video[0];
    }
  }, {
    key: "show",
