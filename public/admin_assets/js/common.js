var common_func = {
    ...
    "examination" : function(type){
        ...
        Array.prototype.forEach.call(els, function(el) {
          ...
          newSpan.style.cssText = "color:red;font-size:13px;vertical-align: top;margin-bottom:5px"
          newSpan.className = "error_span";
          if (el.value.length == 0) {
            // el.style.border="1px solid red";
            var text = document.createTextNode('必填');
